...
holder.detailDate.setText(dataList.get(position).getTarehe());
    ...
    /*  holder.detailUrlClick.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
              ...
              //here parse the image url
           //   String imageUrl;
            //  Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse(imageUrl));
              Toast.makeText(mcontext, "waiting for action here", Toast.LENGTH_SHORT).show();
...
class MyViewHolder extends RecyclerView.ViewHolder{
    // CardView itemcardView;
     TextView detailWorkId, detailDate, detailDetails,
          //  detailStation,
            detailSupervisor, detailPoints, //detailUrlClick,
    detailStation,
             detailShift
              , detailImage;
    ...
    public MyViewHolder(@NonNull View itemView) {
       ...
       detailImage = itemView.findViewById(R.id.image_Url_itemTV);
        //detailUrlClick= itemView.findViewById(R.id.image_Url_item);
